...
READ_CMD:
    ...
    JSR SKIP_SPACES ; skip any cases after READ cmd

    CMPX #NULL      ; no more words in command?
    BEQ READ_WHAT   ; print read what? message

    LDX ,X              ; get first two chars of word in X
    JSR GET_ITEM_PTR    ; get item ptr in Y
    CMPY #NULL          ; if item not found (maybe mis-typed?)
    BEQ READ_WHAT       ; print what? message

    LDA ITEM_LOC_OFFSET, Y  ; get item room loc
    CMPA ROOM
    BEQ READ_HAVE_IT
...
READ_HAVE_IT:
    ...
    LDX #DEFAULT_READ_MSG       ; generic response
...
;[]--------------[]
    ...
    INST_MSG: FCZ "COMMAND EXAMPLES:\r\rmovement: GO NORTH, MOVE SOUTH, EAST\r\ritems: TAKE ITEM, GET ITEM, DROP ITEM, READ ITEM, INVENTORY\r\rdoors: OPEN DOOR, UNLOCK DOOR\r\rPRESS ANY KEY TO CONTINUE..."
    ...
    CANT_DROP_MSG: FCZ "YOU TRY...BUT YOU JUST CAN'T SEEM TO PART WITH IT!\r\r"
    ...
    RD0: FCZ "YOU ARE IN A SMALL DIMLY LIT ROOM. IT SMELLS LIKE BLEACH. MAYBE A STORAGE CLOSET?"
    ...
    RD13: FCZ "YOU ARE IN A SMALL PARLOR. LIKELY THE SERVANTS GATHERED HERE WHEN OFF-DUTY."
    RD14: FCZ "YOU ARE AT THE BOTTOM OF A PIT. THERE IS AN OPENING TO THE SOUTH."
    RD21: FCZ "YOU ARE IN A SMALL BEDROOM. THERE ARE BEDS ALONG THE EAST AND WEST WALLS. A SMALL NIGHT STAND IS PAIRED WITH EACH."
    ...
    RD86: FCZ "YOU ARE IN A LUXURIOUS BEDROOM. A LARGE BED IS CENTERED ON THE NORTH WALL. THERE IS A FIREPLACE ON THE EAST WALL."
    RD88: FCZ "YOU ARE IN A CHILD'S BEDROOM. A SMALL BED IS NESTLED AGAINST THE WEST WALL."
    RD94: FCZ "YOU ARE IN WHAT APPEARS TO BE THE MASTER BEDROOM. A LARGE FIREPLACE IS CENTERED ON THE NORTH WALL. A LARGE FOUR-POST BED IS ON THE EAST WALL. SMALL TABLES ON EITHER SIDE. TO THE WEST BEHIND A TATTERED CURTAIN IS AN OPENING."
    ...
    DOOR_BLUE: FCZ "AZURE DOOR"
    DOOR_RED: FCZ "RED DOOR"
    DOOR_YELLOW: FCZ "YELLOW DOOR"
    ...
    MILDEW: FCZ "IT SMELLS OF MILDEW."

    ; sounds
    DRIPPING: FCZ "WATER DRIPS FAINTLY SOMEWHERE NEARBY."
    INSECTS: FCZ "A CRICKET CHIRPS SOFTLY."
    CLOCK_TICK: FCZ "YOU CAN HEAR A MECHANICAL CLOCK TICKING, TIK TOK...TIK TOK."
    ...
    YELLOW_KEY: FCZ "YELLOW KEY"
    PLAT_KEY: FCZ "PLATINUM KEY"
    SILVER_KEY: FCZ "SILVER KEY"
    ORNATE_KEY: FCZ "ORNATE KEY"
    ...
    ROPE: FCZ "ROPE"
    SKULL: FCZ "SKULL"
    STEEL_BAR: FCZ "STEEL BAR"
    GOLD_BAR: FCZ "GOLD BAR"
    CLUB: FCZ "CLUB"
    BROOM: FCZ "BROOM"
    DANTE_SIGN: FCZ "POSTER"
    MELVILLE_SIGN: FCZ "PLAQUE"
    CHINA: FCZ "CHINA PLATE"
...
ITEMS:
    ...
    FDB ROPE        FCB 21  FDB NULL FCB NORMAL_ITEM
    ...
    FDB SKULL       FCB 43  FDB SKULL_READ FCB NORMAL_ITEM
    ...
    FDB CLUB        FCB 77  FDB NULL FCB NORMAL_ITEM
    FDB CHINA       FCB 79  FDB NULL FCB NORMAL_ITEM
    FDB ORNATE_KEY  FCB 80  FDB NULL FCB NORMAL_ITEM
    FDB STEEL_BAR   FCB 81  FDB NULL FCB NORMAL_ITEM
    FDB SILVER_KEY  FCB 86  FDB NULL FCB NORMAL_ITEM
    FDB BACKPACK    FCB 88  FDB NULL FCB NORMAL_ITEM
    FDB YELLOW_KEY  FCB 92  FDB NULL FCB NORMAL_ITEM
    FDB GOLD_BAR    FCB 94  FDB NULL FCB NORMAL_ITEM
...
DECORATIONS:
    ...
    FDB DRIPPING FCB 24
    FDB ST_NOEA FCB 25
    FDB ST_NOSO FCB 26 FDB SCONCE FCB 26
    FDB ST_NOSO FCB 27
    FDB ST_NOSO FCB 28 FDB SCONCE FCB 28
    FDB EAWE FCB 30
    FDB RD31 FCB 31
    FDB NOSO FCB 32
    FDB SOWE FCB 33
    ...
    FDB NORD FCB 63
    FDB EAWE FCB 64 FDB SCONCE FCB 64
    FDB EAWE FCB 65
    FDB EAWE FCB 66
    FDB NOWE FCB 67 FDB SCONCE FCB 67
    FDB NOSO FCB 68
    FDB NOSO FCB 69 FDB SCONCE FCB 69
    FDB SUD FCB 70
    FDB EAWE FCB 71 FDB SCONCE FCB 71
    FDB NOEA FCB 72
    FDB NOSO FCB 73
    FDB NOSO FCB 74
...
DINST8: FDB DOOR_YELLOW  FCB DOOR_LOCKABLE | DOOR_LOCKED FDB YELLOW_KEY
DINST9: FDB DOOR_PLAIN  FCB 0 FDB 0
DINST10: FDB DOOR_DOUBLE FCB DOOR_LOCKABLE | DOOR_LOCKED FDB ORNATE_KEY
