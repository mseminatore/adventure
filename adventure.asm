...
;[]--------------[]
    ...
    RD5 FCZ "YOU ARE IN A NORTH-SOUTH HALLWAY. TO THE SOUTH THERE IS A PIT IN THE FLOOR."

    RD6 FCZ "YOU ARE IN A SMALL RESTROOM."

    RD8 FCZ "YOU ARE IN A LIBRARY. BOOKS LINE SHELVES ON THE NORTH WALL. TO THE EAST IS A HALLWAY. TO THE WEST STAIRS LEAD UPWARDS."
    ...
    NOWE FCZ "YOU ARE IN A HALLWAY. OPENINGS LEAD NORTH AND WEST."

    SOWE FCZ "YOU ARE IN A HALLWAY. OPENINGS LEAD WEST AND SOUTH."
...
ITEMS
    ...
    FDB GREEN_KEY FCB 6
    FDB GOLD_KEY FCB 14
    FDB SILVER_KEY FCB 10
    FDB BROWN_BOOK FCB 8
    FDB MOP FCB 0
    FDB NULL
